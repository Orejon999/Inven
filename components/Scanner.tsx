...
import { Camera, X, Check, Loader2, AlertCircle, CheckCircle, ArrowRight, AlertTriangle, Building2, Calculator, Pencil, DollarSign } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {!imagePreview && (
        ...
        >
          ...
          />
          <div className="w-24 h-24 bg-blue-50 text-blue-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-sm">
            <Camera size={48} />
          </div>
          <h3 className="text-2xl font-bold text-slate-800 mb-3">Sube tu Factura o Ticket</h3>
          <p className="text-slate-500 max-w-md mx-auto">
            El sistema detectará automáticamente si es USD o Bs basándose en los montos, extraerá el proveedor y calculará bultos.
          </p>
      ...
      {isProcessing && (
        <div className="bg-white p-12 rounded-2xl shadow-lg border border-slate-100 text-center">
          ...
          <p className="text-slate-500">Detectando moneda (Bs vs USD) y calculando unidades.</p>
        </div>
      )}
      ...
      {scanResult && !isProcessing && (
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 flex flex-col h-[calc(100vh-200px)]">
          ...
          <div className="p-6 bg-slate-50 border-b border-slate-200 flex flex-wrap gap-4 justify-between items-center flex-shrink-0 z-10 sticky top-0">
            <div>
              <h2 className="text-xl font-bold text-slate-800">Revisión de Factura</h2>
              <p className="text-sm text-slate-500">Verifica que la moneda sea correcta</p>
            </div>
            ...
            <div className="flex flex-col h-full bg-slate-50/50 overflow-hidden">
              <div className="flex-1 overflow-y-auto p-6 space-y-4">
                ...
                {scanResult.items.map((item, idx) => {
                  ...
                  // Check if a pack size conversion happened
                      ...
                      <div className="flex flex-col gap-3 mb-3">
                        ...
                        <div className="flex justify-between items-end">
                            <div className="text-sm text-slate-600 font-mono flex flex-col">
                                <span className="text-xs text-slate-400">Precio Unitario en Factura</span>
                        ...
                        {isPackConversion && (
                            <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-amber-50 border border-amber-100 text-amber-800 text-xs font-medium w-fit">
                                <Calculator size={12} />
                                <span>
